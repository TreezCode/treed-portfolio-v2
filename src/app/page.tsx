    ...
    loading: () => (
      <div className="w-full h-full bg-transparent" aria-label="Loading 3D scene">
        ...
        <div className="flex items-center justify-center w-full h-full">
          <div className="w-16 h-16 border-2 border-accent-primary/20 border-t-accent-primary rounded-full animate-spin" />
        </div>
      </div>
    )
  }
      ...
      <section id="hero" aria-label="Hero" className="relative w-full h-screen overflow-hidden">
        ...
        >
          ...
          <div className="flex flex-col gap-3 max-w-2xl">
            <span className="text-label text-text-tertiary">Software Engineer · Security+ Certified</span>

            <div className="typed-container min-h-[60px] sm:min-h-[100px] z-10">
              <h1 className="text-display text-text-primary theme-transition">
                <span ref={headTextRef} />
              </h1>
            </div>
            <div className="typed-container min-h-[128px] sm:min-h-[136px] z-10">
              <p className="text-lg sm:text-xl text-text-secondary mt-2 leading-relaxed max-w-xl">
                <span ref={subTextRef} />
              </p>
            </div>
            ...
            >
              ...
              <a
                ...
                className="px-6 sm:px-8 py-3 sm:py-4 bg-accent-fill hover:bg-accent-fill-hover rounded-xl font-semibold text-white transition-colors duration-200"
              >
                View My Work
              </a>
              ...
              <a
                ...
                className="px-6 sm:px-8 py-3 sm:py-4 border border-border-strong rounded-xl font-semibold text-text-primary hover:bg-surface-primary transition-colors duration-200 bg-background-primary/80"
              >
                Let&apos;s Connect
              </a>
            </motion.div>
            ...
            >
              ...
              <a
                ...
                className="group p-3 rounded-lg border border-border-primary hover:border-border-strong bg-surface-primary hover:bg-surface-hover transition-colors duration-200 theme-transition"
                aria-label="GitHub"
              >
