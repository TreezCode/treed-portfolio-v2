        ...
        >
          ...
          <div className="flex flex-col gap-3 max-w-2xl">
            ...
            <div className="typed-container min-h-[60px] sm:min-h-[80px] z-10">
              <h1 className="text-5xl sm:text-7xl font-bold text-text-primary leading-tight theme-transition">
            ...
            >
              ...
              <a
                ...
                className="group p-3 rounded-lg border border-border-primary hover:border-[#915eff] bg-surface-primary hover:bg-[#915eff]/10 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-[#915eff]/30 theme-transition"
                aria-label="GitHub"
              >
                <svg className="w-5 h-5 text-text-secondary group-hover:text-[#915eff] transition-colors" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group p-3 rounded-lg border border-border-primary hover:border-[#00d4ff] bg-surface-primary hover:bg-[#00d4ff]/10 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-[#00d4ff]/30 theme-transition"
                aria-label="LinkedIn"
              >
                <svg className="w-5 h-5 text-text-secondary group-hover:text-[#00d4ff] transition-colors" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group p-3 rounded-lg border border-border-primary hover:border-[#ff6b9d] bg-surface-primary hover:bg-[#ff6b9d]/10 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-[#ff6b9d]/30 theme-transition"
                aria-label="X (formerly Twitter)"
              >
                <svg className="w-5 h-5 text-text-secondary group-hover:text-[#ff6b9d] transition-colors" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                aria-label="Email"
              >
                <svg className="w-5 h-5 text-text-secondary group-hover:text-[#915eff] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
